            ...
            <form id="dataForm" class="needs-validation" method="post" enctype="multipart/form-data" novalidate>
              ...
              <div class="row">
                ...
                <div class="col-md-4 col-sm-12 mb-3">
                  <x-MultipleSelectField label="Select Hospital" name="hospital_id" id="hospital_id" :ft="$ft" :sd="$sd"
                    :list="$hospitals" showv="hospital_name" savev="id"></x-MultipleSelectField>
              ...
              @endif
              @if ($ft == 'edit')
              <a href="{{ aurl($page_route.'/'.$doctor->id) }}" class="btn btn-sm btn-info "><i class="ti-trash"></i>
                Cancel</a>
              @endif
