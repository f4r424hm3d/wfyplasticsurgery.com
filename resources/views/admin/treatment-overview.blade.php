        ...
        <div class="col-12">
          <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            <h4 class="mb-sm-0 font-size-18">
              {{ $page_title }} <span class="text-danger">[ {{ $treatment->hospital_name }} ]
            </h4>
              ...
              <form id="{{ $ft == 'add' ? 'dataForm' : 'editForm' }}" {{ $ft == 'edit' ? 'action=' . $url : '' }}
                ...
                <div class="row">
                  ...
                  <div class="col-md-12 col-sm-12 mb-3">
                    <x-DatalistField type="text" label="Enter Title" name="title" id="title" :ft="$ft"
                      :sd="$sd" :list="$titles" showv="title" savev="title" required="required">
                    </x-DatalistField>
                  </div>
                  <div class="col-md-12 col-sm-12 mb-3">
