  ...
  <main class="theia-exception">
    ...
    <div class="container margin_60_35">
      <div class="row justify-content-between">
        <div class="col-lg-8">
          <div id="detail-title">
            <div class="container bold">Privacy Policy
            </div>
          </div>
          <div class="desti-box mb-0">
            <p>We appreciate your confidence in us and understand the importance of secure data and information
              privacy. This Privacy Statement explains how MedsurgeIndia Private Limited and its affiliates
              (collectively Innayatmedical, we, our, us“) collect, use, share, protect, or otherwise process your
              personal information via the Medsurge India website https://www.innayatmedical.com. While you can browse
              certain sections of the Platform without registering with us, please keep in mind that we do not offer
              any products through this Platform in India. Your personal information will be primarily stored and
              processed in India, which may have data protection laws that differ from those in the country in which
              you reside.</p>
            <p>By visiting this Platform, providing your information, or using any of the Platform’s medical services,
              you expressly agree to be bound by the terms and conditions of this Privacy Policy, the Terms of Use,
              and the applicable medical service terms and conditions, and agree to be governed by Indian laws,
              including but not limited to data protection and privacy laws. Please do not use or access our Platform
              if you do not agree.</p>
            <h4>Collection of Information</h4>
            <p>When you use a Service, we may collect the following types of information:</p>
          </div>
        </div>
