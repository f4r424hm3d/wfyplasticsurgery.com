  ...
  <main class="theia-exception">
    ...
    <div class="container margin_60_35">
      <div class="main_title text-start mb-4">
        <h2 class="text-start">Service <strong>Name</strong> Here</h2>
      </div>
        ...
        <div class="col-lg-8">
          ...
          <div class="bloglist singlepost">
            ...
            <div class="post-content">
              <p>Cosmetic surgery is a medical discipline focused on enhancing beauty and appearance through surgical
                and medical techniques. It is an extremely broad field and can be performed on all areas of the bod;
                face, breates, thigh, stomach, etc. Cosmetic surgery is a part of plastic surgery but concentrated on
                enhancing beauty of a person.</p>
            </div>

            <h3>Cost Of Cosmetic Surgery Treatment In India</h3>
            <div class="post-content">
              <p class="mb-2">The average cost of cosmetic surgery is $1,000. Different types of surgeries carry
                different costs, which include surgeon fees, material costs, anesthesia related costs, follow up
                appointments, etc. There are top hospitals in India providing cosmetic surgery.</p>
              <p>This branch of medicine is highly specialized, making it difficult to determine the cost before
                reviewing the case. The specialists in our network will assess each case individually and recommend a
                personalized treatment plan. Please contact our Care Team to get a treatment plan and quote for a
                treatment.</p>
            </div>
