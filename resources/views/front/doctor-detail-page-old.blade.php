                  ...
                  <div class="col-lg-7 col-md-8">
                    ...
                    <span class="rating">
                      ...
                      <a href="badges.html" data-bs-toggle="tooltip" data-bs-placement="top" title="Badge Level"
                        class="badge_list_1"><img src="{{ url('front') }}/img/badge_1.svg" width="15" height="15"
                          alt=""></a>
                    </span>
                    <ul class="statistic">
                      <li>854 Views</li>
                    ...
                    <ul class="contacts">
                      ...
                      <li>
                        <h6>Phone</h6> <a href="tel://000434323342">+00043 4323342</a> - <a
                          href="tel://000434323342">+00043 4323342</a>
                      </li>
                    </ul>
                  </div>
                </div>
            ...
            <div class="box_general_3">
              <div class="reviews-container">
                ...
                <div class="review-box clearfix">
                  <figure class="rev-thumb"><img src="{{ url('front') }}/img/avatar1.jpg" alt="">
                  </figure>
                ...
                <div class="review-box clearfix">
                  <figure class="rev-thumb"><img src="{{ url('front') }}/img/avatar2.jpg" alt="">
                  </figure>
                  <div class="rev-content">
                    <div class="rating">
                ...
                <div class="review-box clearfix">
                  <figure class="rev-thumb"><img src="{{ url('front') }}/img/avatar3.jpg" alt="">
                  </figure>
                  <div class="rev-content">
                    <div class="rating">
                      <i class="icon-star voted"></i><i class="icon_star voted"></i><i class="icon_star voted"></i><i
              ...
              <div class="row">
                <div class="col-6">
                  <div class="form-group">
                    <input class="form-control" type="text" id="booking_date" data-lang="en" data-min-year="2020"
                      data-max-year="2024" data-disabled-days="10/17/2021,11/18/2021">
                  </div>
                </div>
                <div class="col-6">
                  <div class="form-group">
